...
Antes de iniciar, es fundamental instalar las librerías necesarias, se recomienda el uso de un entorno virtual para evitar conflictos de versiones: 
pip install -r requirements.txt

Nota: El archivo requirements.txt incluye pymongo, selenium, beautifulsoup4 y las herramientas necesarias para la limpieza de datos que realiza el main.py.

3. Despliegue de Infraestructura (Docker)
Levanta la orquestación de contenedores en modo segundo plano, este comando activará el motor de MongoDB, el Workspace y las herramientas de visualización: 
docker-compose up -d

Puedes verificar que los 4 servicios estén operativos corriendo docker-compose ps. 

4. Ejecución del Orquestador y Carga Local
Una vez que la infraestructura esté lista podrás ejecutar el script principal, este proceso activará los scrapers, normalizará los precios y guardará los registros en tu base de datos local: 
python main.py
...
![Conteo de documentos MongoDB](evidencias/E2_mongo_felipe_gutierrez.png)
![Conteo de documentos MongoDB](evidencias/E2_mongo_franco_teyssandier.png)
![Conteo de documentos MongoDB](evidencias/E2_mongo_jorge_chavez.png)
![Conteo de documentos MongoDB](evidencias/E2_mongo_mariana_ferreira.png)
![Conteo de documentos MongoDB](evidencias/E2_mongo_franco_paredes.png)
![Conteo de documentos MongoDB](evidencias/E2_mongo_renato_gutierrez.png)
![Conteo de documentos MongoDB](evidencias/E2_mongo_isidora_matus.png)
![Conteo de documentos MongoDB](evidencias/E2_mongoatlas.png)
